...
export declare const parseDiff: (diff: string) => string[];
export declare const getPullRequestDiff: (prDetails: PRDetails) => Promise<import("@octokit/types").OctokitResponse<{
    url: string;
    id: number;
    node_id: string;
    html_url: string;
...
export declare const createPRComment: (prDetails: PRDetails, body: string) => Promise<void>;
export declare const updatePRDescription: (prDetails: PRDetails, body: string) => Promise<void>;
export declare const getChangedFiles: (files: string[]) => string;
